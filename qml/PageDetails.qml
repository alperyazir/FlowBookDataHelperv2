...
Item {
        ...
        Menu {
            ...
            MenuItem {
                ...
                onTriggered: {
                    ...
                    // }
                    var answer = root.activeSession.createNewAnswer(originalX, originalY, lastWidth ,lastHeight);
    ...
    Flickable {
        ...
        Image {
            id: picture
            source: qsTr("file:" + appPath + modelData.image_path)
                                ...
                                MouseArea {
                                    ...
                                    onPositionChanged: {
                                        if(drag.active){
                                            ...
                                            // Minimum boyutları belirle
                                            if (answerCircleRect.width < 20) answerCircleRect.width = 20;
                                            if (answerCircleRect.height < 10) answerCircleRect.height = 10;
                                        }
                                    }
                                    onReleased: answerCircleRect.setStatus()
