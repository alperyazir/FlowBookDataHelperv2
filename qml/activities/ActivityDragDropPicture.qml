...
Rectangle {
    ...
    // Give every other selected answer the same size (w/h in original coords).
                    ...
                    Image {
                        ...
                        Repeater {
                            ...
                            Item {
                                ...
                                // Group resize: re-sync the live size when the model
                                // coords change (so this zone follows along).
                                Connections {
                                    target: modelData
