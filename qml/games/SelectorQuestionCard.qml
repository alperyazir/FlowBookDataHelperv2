...
Rectangle {
    ...
    Column {
        ...
        // Question Media Section - 2x2 Grid
        Rectangle {
            width: parent.width
            ...
            Column {
                ...
                GridLayout {
                    ...
                    // Text field (full width - spans 2 columns)
                    Row {
                        Layout.columnSpan: 2
                    ...
                    Repeater {
                        ...
                        Rectangle {
                            ...
                            Layout.preferredHeight: {
                                ...
                                return Math.max(26, (parent.height - (rows - 1) * 3) / rows);
                            }
                            color: "#1A2327"
                            border.color: "#445055"
                            border.width: 1
                            ...
                            Row {
                                ...
                                // Correct checkbox
                                Rectangle {
                                    width: Math.min(18, parent.height - 2)
                                    height: width
                                    radius: 3
                                    color: "white"
                                    border.color: "#009ca6"
